...
public class Network extends Module<Koru>{
	public static final String ip = System.getProperty("user.name").equals("cobalt") ? "localhost" : "107.11.42.20";
	...
	private void sendUpdate(){
		...
		// pos.mouseangle = Angles.mouseAngle(getModule(Renderer.class).camera,
		// getModule(ClientData.class).player.getX(),
