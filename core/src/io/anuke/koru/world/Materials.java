...
public enum Materials implements Material{
	...
	water(MaterialType.water, 1, Hue.mix(41, 97, 155, 102, 102, 102, 0.3f)){{addDrop(Items.water, 1);}},
	deepwater(MaterialType.water, 1, Hue.mix(41, 97, 155, 102, 102, 102, 0.3f)){{addDrop(Items.water, 1);}},
	blackrock,
	magmarock,
	cobblestone,
	sand{{vary(7);}},
	...
	rock1(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x717171ff);}},
	rock2(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x717171ff);}},
	rock3(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x717171ff);}},
	rock4(MaterialType.object, -2f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x717171ff);}},
	...
	deadtree1(MaterialType.tree, -4f),
	deadtree2(MaterialType.tree, -3f),
	deadtree3(MaterialType.tree, -4f),
	deadtree4(MaterialType.tree, -1f),
	...
	burnedtree1(MaterialType.tree, -1f),
	burnedtree2(MaterialType.tree, -1f),
	burnedtree3(MaterialType.tree, -1f),
	burnedtree4(MaterialType.tree, -1f),
	pinetree1(MaterialType.tree, -5f){{addDrop(Items.wood, 10);breakt(90);}}, 
	pinetree2(MaterialType.tree, -3f){{addDrop(Items.wood, 10);breakt(90);}}, 
	...
	stonepillar(MaterialType.block, 100){{addDrop(Items.stone, 2); color = new Color(0x717171ff);}},
	stoneblock(MaterialType.block, 50){{addDrop(Items.stone, 5); color = new Color(0x717171ff);}},
