...
public enum Materials implements Material{
	...
	rock1(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x744a28ff);}},
	rock2(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x744a28ff);}},
	rock3(MaterialType.object, -1f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x744a28ff);}},
	rock4(MaterialType.object, -2f){{breakt(50); addDrop(Items.stone, 2); color = new Color(0x744a28ff);}},
